...
- [Challenges](#challenges)
  ...
  - [Implementation Challenges](#implementation-challenges)
    - [Pico Challenges](#pico-challenges)
...
3. Stim Train Plotter: ~25% finished
    - A switch from JSON to CSV necessitated a large refactor of the plotter
    - Pan, zoom,
