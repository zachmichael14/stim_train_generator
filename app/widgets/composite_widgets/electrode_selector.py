...
from app.widgets.composite_widgets import single_electrode, multi_electrode
...
class ElectrodeSelectorWidget(QWidget):
    ...
    def handle_stim_on(self):
        """
        Select electrode automatically when stim is on (single electrode mode).
        ...
        This means that toggling stim on in single electrode mode will deliver stimulation even with the electrode deselected because the 'channel' stim parameter provided by the electrode selector would be irrelevant.
